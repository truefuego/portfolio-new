...
const CustomAboutMeSection:React.FC = () => {
  return (
    <div className='relative flex flex-col items-center w-screen'>
      <CustomImage src={GridLines} alt='grid-lines' classes='absolute bg-primary-background'/>
      <div className='grid grid-cols-2 z-10 pt-48 w-[85%]'>
        ...
        <CustomText 
          title='I excel in crafting optimized backend systems, intuitive user interfaces, and high-performance applications.'
          classes='text-4xl w-[35vw] bg-stack-card-background p-8 h-fit rounded-3xl'
          fontFamily='funnel-sans-semibold'
        />
      </div>
      <div className='w-[65%] z-10 mt-36'>
